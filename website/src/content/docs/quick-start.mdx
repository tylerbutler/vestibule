  ...
  <div className="primary-path">
    <div className="path-body">
      ...
      <p>
        ...
        provided by vestibule_github; provider packages add Google, Microsoft,
        or Apple.
      </p>
  ...
  <details id="core-path" className="path-panel">
    ...
    <div className="path-body">
      ...
      <p>
        ...
        <code>authorization_request.code_verifier(auth_request)</code> before redirecting. Pass the
