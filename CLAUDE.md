...
- **publish.yml** (workflow name: Release): On the release PR merging — records per-package tags and GitHub Releases. **Releases are git-only**; nothing is uploaded to Hex
